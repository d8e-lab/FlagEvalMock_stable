...
torchrun --nproc-per-node 8 /mnt/SFT_store/3090_eval/FlagEvalMock_stable/main_v2dist.py --dataset-names="BoolQ,MMLU,TruthfulQA,RAFT,GAOKAO2023,CSL,ChID,CLUEWSC,EPRSTMT,TNEWS,OCNLI,BUSTM"\
    --model-name $MODEL \
