...
# export CUDA_VISIBLE_DEVICES=3,4,5,6,7 /mnt/SFT_store/3090_eval/FlagEvalMock_stable/wyh_sample/81_no_imdb.sh
...
nproc=${#arr[@]}
torchrun --nproc-per-node ${nproc} /mnt/SFT_store/3090_eval/FlagEvalMock_stable/main_v2dist.py --dataset-names="BoolQ,MMLU,TruthfulQA,RAFT,GAOKAO2023,CSL,ChID,CLUEWSC,EPRSTMT,TNEWS,OCNLI,BUSTM"\
    --model-name $MODEL \
