...
# torchrun --nproc-per-node 2 --rdzv-endpoint 0.0.0.0:$2 /mnt/SFT_store/3090_eval/FlagEvalMock_stable/main_v2dist.py --dataset-names="OCNLI" \
torchrun --nproc-per-node 2 --rdzv-endpoint 0.0.0.0:$2 /mnt/SFT_store/3090_eval/FlagEvalMock_stable/main_v2dist.py --dataset-names="CSL"\
    --model-name $MODEL \
